...
namespace DevExpress.DevAV {
    public partial class MainForm : XtraForm, IMainModule, ISwipeGestureClient {
        ...
        public MainForm() {
            ...
            PrepareUI();
            InitViewModel();
            Utils.About.UAlgo.Default.DoEventObject(Utils.About.UAlgo.kDemo, Utils.About.UAlgo.pWinForms, this);
        }

        void ShowSplashScreen() 
        {
            SplashScreenManager.ShowForm(typeof(SplashScreen1));
            //XtraSplashScreen.SplashScreenManager.ShowDefaultSplashScreen(this, true, true, "DevExpress WinForms Controls", "When Only the Best Will Do");
        }
